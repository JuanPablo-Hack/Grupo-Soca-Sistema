        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <form action="php/agregar_muestra2.php" class="form-horizontal style-form" method='POST' enctype="multipart/form-data">
              ...
              <div class="form-group" style="display: none;">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name='info_geo' class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Peso especifico</label> 
                  <div class="col-sm-4">
                    <input type="text" name='peso_esp' class="form-control">
                  </div>
                </div>
                <div class="form-group">
