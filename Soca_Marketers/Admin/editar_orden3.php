        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <form action="php/editar_orden3.php" class="form-horizontal style-form" method='POST' enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="form-group last">
                  <label class="control-label col-md-3">Evidencias del Camión</label>
                  <div class="col-md-9">
                ...
                <div class="form-group last">
                  <label class="control-label col-md-3">Evidencias de la Pesada</label>
                  <div class="col-md-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                        <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=no+image" alt="" />
