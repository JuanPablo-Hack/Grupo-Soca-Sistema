...
if ($conexion ->connect_error) {
    die("Conexion Fallida: " . $conn ->connect_error);
        ...
        $sql="UPDATE muestras SET fecha_recep='$fecha_recep',folio='$folio',material='$material',peso='$peso',tipo_muestra='$tipo',lab_ext='$lab_ext',fecha_envio='$fecha_envio',servicio_soli='$servicio_soli',ele_ana='$ele_ana',localidad='$localidad',info_geo='$info_geo',peso_esp='$peso_esp',observaciones='$observaciones',estado='$estado',ruta='$archivo'  WHERE id='$id'";
