  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Bitacora de salida de patio acopio</h3>
        <div class="row mb">
          <!-- page start-->
                ...
                <?php
                  ...
                  <tr >
                    ...
                    <td>
                      ...
                      <a href='../salidas/<?php echo $mostrar['no_guia'] . "/".$mostrar['foto']?>'  target="_blank" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
