<?php
  ...
  {
    $nombre_empresa= $Row['id_trans'];
    
    $operador=$Row['operador'];
    $cargo=$Row['cargo'];
    $licencia=$Row['licencia'];
    $tel_operador=$Row['tel_operador'];
    $modelo=$Row['modelo'];
    $placas=$Row['placas'];
    $ano=$Row['ano'];
    $capcidad=$Row['capcidad'];
    $color=$Row['color'];
    $seguro=$Row['seguro'];
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="./php/editar_trans.php">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="firstname" name="identificador" type="hidden" value="<?php echo $id; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control " id="username" name="operador" type="text" value="<?php echo $operador; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control " id="username" name="licencia" type="text" value="<?php echo $licencia; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="password" class="control-label col-lg-2">Telefono</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="password" name="tel_operador" type="text" value="<?php echo $tel_operador; ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control " id="username" name="modelo" type="text" value="<?php echo $modelo; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="username" class="control-label col-lg-2">Placas</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="username" name="placas" type="text" value="<?php echo $placas; ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control " id="password" name="ano" type="text" value="<?php echo $ano; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="password" class="control-label col-lg-2">Capacidad</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="password" name="capcidad" type="text" value="<?php echo $capcidad; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="password" class="control-label col-lg-2">Color</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="password" name="color" type="text" value="<?php echo $color; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="password" class="control-label col-lg-2">Seguro</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="password" name="seguro" type="text" value="<?php echo $seguro; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="password" class="control-label col-lg-2">Descripción</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="password" name="descripcion" type="text" value="<?php echo $descripcion; ?>"/>
                                        </div>
                                    </div>
