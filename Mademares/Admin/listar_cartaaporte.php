  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Listar Carta Aporte</h3>
        <div class="row mb">
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th>Folio</th>
                    <th>Materia</th>
                    <th class="hidden-phone">Clase</th>
                    <th class="hidden-phone">CPA</th>
