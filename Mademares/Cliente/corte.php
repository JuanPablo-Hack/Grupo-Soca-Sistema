                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="well well-small green">
                      <div class="pull-left"> Importe : </div>
                      <div class="pull-right"> <?php echo $importe; ?> </div>
                      <div class="clearfix"></div>
                    </div>
                  </div>
                  <!-- /invoice-body -->
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colspan="2" rowspan="4">
                        ...
                        <p> Gracias por su negocio. Esperamos el pago dentro de los 21 días, así que procese esta factura dentro de ese tiempo. Habrá un cargo de interés del 1.5% por mes en facturas atrasadas. </p>                        <td class="text-right"><strong>Subtotal</strong></td>
                        <td class="text-right">$<?php echo $importe; ?>.00</td>
                    </tr>
                    <tr>
                      <td class="text-right no-border"><strong>Envío</strong></td>
                      <td class="text-right">$0.00</td>
                    </tr>
                    <tr>
                      <td class="text-right no-border"><strong>IVA incluido en total</strong></td>
                      <td class="text-right">$0.00</td>
                    </tr>
                    <tr>
                      ...
                      <td class="text-right"><strong>$<?php echo $importe; ?>.00</strong></td>
                    </tr>
                  </tbody>
                </table>
                <br>
